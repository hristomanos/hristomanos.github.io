export const projects = [
  ...
  },
  {
    ...
    longDescription:
      "DirectX 11 is a low-level C++ rendering API that enables us to create visually stunning real-time applications. Interacting with DirectX 11 requires a deep understanding of graphics programming concepts. Implementing those concepts as part of my university course was the best way for me to learn. This project features normal mapping, parallax mapping, post-processing effects and lighting. Additionally, I implemented procedural terrain generation using a heighmap. However, it produced sharp edges and a terrain that didn't look natural. To fix this, I implemented the Diamond-Square algorithm for terrain smoothing, resulting in a more natural-looking landscape with smoother edges and better overall terrain quality." ,
